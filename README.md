...
As a precaution, you should run FWCracker from the safety of your venv. You should also launch your venv before you install PySerial. If FWCracker has trouble running *pyserial-ports*, then you'll have to add it to your *PATH*
